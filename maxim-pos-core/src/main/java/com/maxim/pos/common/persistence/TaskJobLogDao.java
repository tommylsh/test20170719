...
public class TaskJobLogDao extends HibernateEntityDAO<TaskJobLog, Long> {
    ...
    public static final String HQL_findLatestTaskJobLogId = "findLatestTaskJobLogId";
    ...
    public static final String SQL_findTaskJobLogIndicateLatest = "findTaskJobLogIndicateLatest";
    ...
    public static final String SQL_updateTaskJobLogNotLatestByKey = "updateTaskJobLogNotLatestByKey";
    public static final String SQL_updateTaskJobLogUndeletableNoneToFail = "updateTaskJobLogUndeletableNoneToFail";
...
//        PosDaoCmd cmd = new PosDaoCmd(HQL_findLatestTaskJobLog, paramMap);
        ...
        Long taskJobLogId = (Long) getSingleByQueryKey(HQL_findLatestTaskJobLogId, paramMap);
        if (taskJobLogId != null)
        {
        	return this.findByKey(taskJobLogId);
        }
...
//				branchCode, sql);
	...
	public int updateTaskJobLogUndeletableNoneToFail(Direction direction, Long branchSchemeId, PollSchemeType pollSchemeType,
    		String branchCode, Long newTaskJobLogId) {
	    Map<String, Object> paramMap = new HashMap<String, Object>();
	    paramMap.put("direction", direction.toString());
	    paramMap.put("branchSchemeId", branchSchemeId);
	    paramMap.put("pollSchemeType", pollSchemeType.toString());
	    ...
	    String sql = processTemplate(SQL_updateTaskJobLogUndeletableNoneToFail, paramMap);
...
//      String sql = processTemplate(SQL_updateOtherTaskJobLogNotLatest, paramMap);
        ...
        List<BigDecimal> results = (List<BigDecimal>) super.getListByQueryKey(SQL_findTaskJobLogIndicateLatest, paramMap, BigDecimal.class);
        
        String sql = queryFileHandler.getQueryFile().getString(SQL_updateTaskJobLogNotLatestByKey);

		SqlParameterSource[] sources = new SqlParameterSource[results.size()];
		int i = 0 ;
        for (BigDecimal id : results)
        {
    		HashMap<String, BigDecimal> map = new HashMap<String, BigDecimal>();
    		map.put("taskJobLogId", id);
    		sources[i++] = new MapSqlParameterSource(map);
        }
		
		
		int[] returnInts = this.jdbcTemplate.batchUpdate(sql, sources);
