...
public class LogUtils {
	...
	public static final Logger FILE_COPY_LOGGER = LoggerFactory.getLogger(PollSchemeType.FILE_COPY.name());
...
//		}
	...
	public static void printException(String message) {
		if (getCurrentThreadLogger() != null) {
			getCurrentThreadLogger().error(message);
		} else {
	...
	public static void printException(Logger logger, String message) {
		if (getCurrentThreadLogger() != null) {
			getCurrentThreadLogger().error(message);
		} else {
			LOGGER.error(message);
	...
	public static void printException(String format, Object... arguments) {
        Logger logger = getCurrentThreadLogger();
		if (logger == null) {
			if (getCurrentThreadLogger() != null) {
				getCurrentThreadLogger().error(format, arguments);
			} else {
