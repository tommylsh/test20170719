...
echo %JAVA_PATH%/bin/java -cp %WEBLOGIC_JAR%  weblogic.Deployer -url %WEBLOGIC_ADMIN_URL% -user %WEBLOGIC_USER% -password %WEBLOGIC_PASSWORD% -undeploy -name %DEPLOY_REST_NAME% >  %PUTTY_FILE_SCRIPT%
